...
public class DriveQuickstart {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = DriveQuickstart.class.getResourceAsStream(Constant.CREDENTIALS_FILE_PATH);
        if (in == null) {
        ...
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
                HTTP_TRANSPORT, Constant.JSON_FACTORY, clientSecrets, Constant.SCOPES_DRIVE_METADATA_READONLY)
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        Drive service = new Drive.Builder(HTTP_TRANSPORT, Constant.JSON_FACTORY, getCredentials(HTTP_TRANSPORT))

...
public class CreateGoogleFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        java.io.File uploadFile = new java.io.File("C:\\Users\\Lenovo\\Desktop\\credentials.json");
 
        // Create Google File:  1UXCcfK5pjqfInkwBynOY0YphNqlA0O5j
 
        File googleFile = createGoogleFile("1UXCcfK5pjqfInkwBynOY0YphNqlA0O5j", "text/plain", "newfile.txt", uploadFile);
